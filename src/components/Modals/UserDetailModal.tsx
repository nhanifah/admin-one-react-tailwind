        ...
        >
            <Formik initialValues={user} onSubmit={(values) => handleFormSubmit(values)}>
                <Form>
                        ...
                        <option value="" disabled>Pilih Hak Akses</option>
                            {
                                ...
                                }) : <option value="" hidden>Tidak ada opsi yang bisa dipilih</option>
                            }
                        </Field>
                    </FormField>
                    ...
                    { user.id.length > 0 ? <Button label="Reset Password" color="danger" full onClick={() => handleResetPassword(user)} /> : null}
                    </div>
                </Form>
            </Formik>
        </WideCardBoxModal>
