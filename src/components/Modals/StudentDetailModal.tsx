      ...
      <Formik
        initialValues={{
          ...
          master_referral: {
            ...
            name: student.master_referral ? student.master_referral.name : 'Tidak ada referral',
          },
          referral_source: student.master_referral ? student.referral_source : 'Tidak ada referral',
          dormitory: student.dormitory == 'yes' ? 'ya' : 'tidak',
          installment: student.installment == 'yes' ? 'ya' : 'tidak',
          interview_schedule: {
            ...student.interview_schedule,
            interview_date: new Date(student.interview_schedule.interview_date).toLocaleDateString(
              'id-ID',
              {
                weekday: 'long',
                year: 'numeric',
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-3 ">
            ...
            <div className="mb-3">
              <FormField label="Jadwal Interview">
                <Field name="interview_schedule.interview_date" id="interview_date" disabled />
              </FormField>
            </div>
